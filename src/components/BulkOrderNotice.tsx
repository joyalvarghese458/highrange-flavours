...
export function BulkOrderNotice() {
  return (
    <section className="bg-ivory px-4 pb-6 pt-10 sm:px-6 md:py-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 rounded-lg border border-gold/25 bg-forest px-5 py-6 text-ivory shadow-xl shadow-forest/10 sm:px-7 md:flex-row md:items-center md:justify-between">
        <div className="flex gap-4">
          ...
          <div>
            <p className="text-xs font-extrabold uppercase tracking-[0.16em] text-gold md:tracking-[0.22em]">
              Bulk Orders Open
            </p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row md:shrink-0">
          <InternalHashLink
            href="/#contact"
            className="inline-flex items-center justify-center rounded-full border border-gold/35 px-5 py-3 text-sm font-extrabold uppercase tracking-[0.16em] text-gold transition hover:bg-gold hover:text-forest md:tracking-[0.14em]"
          >
            Contact Us
          </InternalHashLink>
          <a
